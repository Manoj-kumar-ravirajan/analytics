...
SELECT 
    ...
    customer_id,
    CASE
    WHEN auto_lifetime_rides IS NULL THEN 'NEW'
    ...
    WHEN auto_lifetime_last_ride_date < (DATE_TRUNC('month', DATE(month)) - INTERVAL '90' DAY) THEN '3. >90_DAYS'
    ELSE 'LTR=0'
    END recency_auto
...
SELECT 
        ...
        COALESCE(b.recency_auto, 'LTR=0') recency_auto,
