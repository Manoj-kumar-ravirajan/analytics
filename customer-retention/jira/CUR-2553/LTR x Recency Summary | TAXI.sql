...
SELECT 
    ...
    customer_id,
    CASE
    WHEN taxi_lifetime_rides IS NULL THEN 'NEW'
    ...
    WHEN taxi_lifetime_last_ride_date < (DATE_TRUNC('month', DATE(month)) - INTERVAL '90' DAY) THEN '3. >90_DAYS'
    ELSE 'LTR=0'
    END recency_taxi
...
SELECT 
        ...
        COALESCE(b.recency_taxi, 'LTR=0') recency_taxi,
