...
v0 as
(
select city, week_start_date, coalesce(lifetime_stage_link, 'NEW') lifetime_stage_link,
...
from final_v0
group by city, week_start_date,lifetime_stage_link
order by city, week_start_date,lifetime_stage_link
)
