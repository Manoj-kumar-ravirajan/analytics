...
def clevertap_raw_view():
    raw_view = """CREATE VIEW hive.raw.clevertap_customer_postorderstatus_dropped SECURITY DEFINER AS SELECT eventname , yyyymmdd , hhmmss , quarter_hour , epoch , created_ist , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.appVersion') deviceInfo_appVersion , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.browser') deviceInfo_browser , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.dimensions.height') deviceInfo_dimensions_height , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.dimensions.unit') deviceInfo_dimensions_unit , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.dimensions.width') deviceInfo_dimensions_width , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.dpi') deviceInfo_dpi , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.make') deviceInfo_make , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.model') deviceInfo_model , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.osVersion') deviceInfo_osVersion , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.sdkVersion') deviceInfo_sdkVersion , JSON_EXTRACT(profile, '$.profile.all_identities') profile_all_identities , JSON_EXTRACT_SCALAR(profile, '$.profile.email') profile_email , JSON_EXTRACT_SCALAR(profile, '$.profile.identity') profile_identity , JSON_EXTRACT_SCALAR(profile, '$.profile.name') profile_name , JSON_EXTRACT_SCALAR(profile, '$.profile.phone') profile_phone , JSON_EXTRACT_SCALAR(profile, '$.profile.platform') profile_platform , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.area') eventProps_area , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.currentCity') eventProps_currentCity , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.currentCluster') eventProps_currentCluster , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.epoch') eventProps_epoch , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.hhmmss') eventProps_hhmmss , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.latitude') eventProps_latitude , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.locationAccuracy') eventProps_locationAccuracy , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.longitude') eventProps_longitude , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.occurred_date') eventProps_occurred_date , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.yyyymmdd') eventProps_yyyymmdd , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.CTAppVersion') eventProps_CTAppVersion , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.CTLatitude') eventProps_CTLatitude , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.CTLongitude') eventProps_CTLongitude , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.CTSource') eventProps_CTSource , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.CTSessionId') eventProps_CTSessionId , JSON_EXTRACT(deviceInfo, '$.deviceInfo') deviceInfo_data , JSON_EXTRACT(profile, '$.profile') profile_data , JSON_EXTRACT(eventProps, '$.eventProps') eventProps_data FROM hive.raw.clevertap_customer_events_master WHERE (eventname = 'postorderstatus_dropped')"""
    return raw_view
