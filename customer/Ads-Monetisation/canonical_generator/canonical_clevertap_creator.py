...
def clevertap_raw_view():
    raw_view = """CREATE VIEW hive.raw.clevertap_customer_nativepaymentpage SECURITY DEFINER AS SELECT eventname , yyyymmdd , hhmmss , quarter_hour , epoch , created_ist , profile , eventProps , deviceInfo , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.appVersion') deviceInfo_appVersion , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.browser') deviceInfo_browser , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.dimensions.height') deviceInfo_dimensions_height , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.dimensions.unit') deviceInfo_dimensions_unit , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.dimensions.width') deviceInfo_dimensions_width , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.dpi') deviceInfo_dpi , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.make') deviceInfo_make , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.model') deviceInfo_model , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.osVersion') deviceInfo_osVersion , JSON_EXTRACT_SCALAR(deviceInfo, '$.deviceInfo.sdkVersion') deviceInfo_sdkVersion , JSON_EXTRACT(profile, '$.profile.all_identities') profile_all_identities , JSON_EXTRACT_SCALAR(profile, '$.profile.email') profile_email , JSON_EXTRACT_SCALAR(profile, '$.profile.identity') profile_identity , JSON_EXTRACT_SCALAR(profile, '$.profile.name') profile_name , JSON_EXTRACT_SCALAR(profile, '$.profile.phone') profile_phone , JSON_EXTRACT_SCALAR(profile, '$.profile.platform') profile_platform , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.app_variant') app_variant , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.cleverTapId') cleverTapId , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.context') context , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.currentCity') currentCity , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.currentCluster') currentCluster , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.fare') fare , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.latitude') latitude , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.longitude') longitude , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.orderId') orderId , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.paymentMode') paymentMode , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.userId') userId , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.source') source , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.CTAppVersion') CTAppVersion , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.CTLatitude') CTLatitude , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.CTLongitude') CTLongitude , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.CTSessionId') CTSessionId , JSON_EXTRACT_SCALAR(eventProps, '$.eventProps.CTSource') CTSource FROM hive.raw_internal.clevertap_customer_events_v2 WHERE (eventname = 'nativepaymentpage')"""
    return raw_view
