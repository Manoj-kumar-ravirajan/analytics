...
WITH iallocator_cte AS ( 
    ...
    SELECT
        ...
        COUNT(DISTINCT merge.customer_id) AS rf_segment_gross_customers_w1
    FROM 
        merge AS merge
    GROUP BY 
        week_no,
...
WITH iallocator_cte AS ( 
    ...
    SELECT
        ...
        merge.taxi_ltr_segments AS taxi_ltr_segments,
        merge.taxi_retention_segments AS taxi_retention_segments,
        COUNT(DISTINCT merge.customer_id) AS rf_segment_gross_customers_w2
    FROM 
        merge AS merge
    GROUP BY 
        week_no,
...
WITH iallocator_cte AS ( 
    ...
    SELECT
        ...
        merge.taxi_ltr_segments AS taxi_ltr_segments,
        merge.taxi_retention_segments AS taxi_retention_segments,
        COUNT(DISTINCT merge.customer_id) AS rf_segment_gross_customers_w3
    FROM 
        merge AS merge
    GROUP BY 
        week_no,
...
WITH iallocator_cte AS ( 
    ...
    SELECT
        ...
        merge.taxi_ltr_segments AS taxi_ltr_segments,
        merge.taxi_retention_segments AS taxi_retention_segments,
        COUNT(DISTINCT merge.customer_id) AS rf_segment_gross_customers_w4
    FROM 
        merge AS merge
    GROUP BY 
        week_no,
