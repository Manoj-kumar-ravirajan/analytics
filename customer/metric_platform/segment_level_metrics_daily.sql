-- count_total_customer_segment_daily
with customer_segments AS (
    ...
    SELECT
        segments.taxi_usecase_segment,
        segments.predicted_age,
        segments.os,
        segments.taxi_need_segment,
        segments.taxi_retention_segment,
        segments.multi_city_segment,
        segments.cross_sell_segment,
        segments.geo_usecase_segment,
        segments.rha_signal,
        segments.quick_commerce_signal,
        segments.vehicle_ownership_signal,
        segments.new_repeat_signal,
        COUNT(DISTINCT segments.customer_id) AS count_total_customer_segment_daily
    FROM
        customer_segments AS segments
    GROUP BY
        segments.taxi_usecase_segment,
        segments.predicted_age,
        segments.os,
...
-- count_fe_events_segment_daily
-- count_taxi_fe_events_segment_daily
with customer_segments as (
    SELECT
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    select
        ...
        count(distinct segment_fe_merge.fe_id) as count_taxi_fe_events_segment_daily
    from
...
-- count_taxi_fe_events_wo_parcel_segment_daily
with customer_segments as (
    SELECT
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    WHERE 
        sdid.service_category IN ('link', 'auto', 'cab')
        AND sdid.service_level_l2 NOT IN ('auto c2c', 'c2c')
    ),
    ...
    select
        ...
        segment_fe_merge.vehicle_ownership_signal,
        segment_fe_merge.new_repeat_signal,
        count(distinct segment_fe_merge.fe_id) as count_taxi_fe_events_wo_parcel_segment_daily
    from
        segment_fe_merge as segment_fe_merge
    group by
        segment_fe_merge.taxi_usecase_segment,
...
-- count_fe_sessions_segment_daily
-- count_taxi_fe_sessions_segment_daily
with customer_segments as (
    SELECT
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_fe_merge.vehicle_ownership_signal,
        segment_fe_merge.new_repeat_signal,
        count(distinct segment_fe_merge.fe_session) as count_taxi_fe_sessions_segment_daily
    FROM
        segment_fe_merge as segment_fe_merge
    GROUP BY
        segment_fe_merge.taxi_usecase_segment,
...
-- count_taxi_fe_sessions_wo_parcel_segment_daily
with customer_segments as (
    SELECT
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_fe_merge.vehicle_ownership_signal,
        segment_fe_merge.new_repeat_signal,
        count(distinct segment_fe_merge.fe_session) as count_taxi_fe_sessions_wo_parcel_segment_daily
    FROM
        segment_fe_merge as segment_fe_merge
    GROUP BY
        segment_fe_merge.taxi_usecase_segment,
...
-- count_fe_customers_segment_daily
with customer_segments as (
    SELECT
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    select
        ...
        segment_fe_merge.vehicle_ownership_signal,
        segment_fe_merge.new_repeat_signal,
        count(distinct segment_fe_merge.customer_id) as count_fe_customers_segment_daily
    from
        segment_fe_merge as segment_fe_merge
    group by
        segment_fe_merge.taxi_usecase_segment,
...
-- count_fe_customers_wo_parcel_segment_daily



-- count_ao_customers_segment_daily
with customer_segments AS (
    SELECT 
        segments.run_date as run_date,
        segments.taxi_lifetime_last_ride_city as taxi_lifetime_last_ride_city,
    ...
    select
        ...
        count(distinct segment_ao_merge.user_id) as count_ao_customers_segment_daily
...
-- count_ao_events_serviceable_segment_daily
with customer_segments AS (
    SELECT 
        segments.run_date as run_date,
        segments.taxi_lifetime_last_ride_city as taxi_lifetime_last_ride_city,
    ...
    select
        ...
        segment_ao_merge.vehicle_ownership_signal,
        segment_ao_merge.new_repeat_signal,
        count(distinct segment_ao_merge.ao_event_id) as count_ao_events_serviceable_segment_daily
    from
        segment_ao_merge as segment_ao_merge
    group by
        segment_ao_merge.taxi_usecase_segment,
...
-- count_ao_sessions_serviceable_segment_daily
with customer_segments AS (
    SELECT 
        segments.run_date as run_date,
        segments.taxi_lifetime_last_ride_city as taxi_lifetime_last_ride_city,
    ...
    select
        ...
        segment_ao_merge.vehicle_ownership_signal,
        segment_ao_merge.new_repeat_signal,
        count(distinct segment_ao_merge.ao_unique_id) as count_ao_sessions_serviceable_segment_daily
    from
        segment_ao_merge as segment_ao_merge
    group by
        segment_ao_merge.taxi_usecase_segment,
...
-- count_ao_events_unserviceable_segment_daily
with customer_segments AS (
    SELECT 
        segments.run_date as run_date,
        segments.taxi_lifetime_last_ride_city as taxi_lifetime_last_ride_city,
    ...
    select
        ...
        segment_ao_merge.vehicle_ownership_signal,
        segment_ao_merge.new_repeat_signal,
        count(distinct segment_ao_merge.ao_event_id) as count_ao_events_unserviceable_segment_daily
    from
        segment_ao_merge as segment_ao_merge
    group by
        segment_ao_merge.taxi_usecase_segment,
...
-- count_ao_sessions_unserviceable_segment_daily
with customer_segments AS (
    SELECT 
        segments.run_date as run_date,
        segments.taxi_lifetime_last_ride_city as taxi_lifetime_last_ride_city,
    ...
    select
        ...
        segment_ao_merge.vehicle_ownership_signal,
        segment_ao_merge.new_repeat_signal,
        count(distinct segment_ao_merge.ao_unique_id) as count_ao_sessions_unserviceable_segment_daily
    from
        segment_ao_merge as segment_ao_merge
    group by
        segment_ao_merge.taxi_usecase_segment,
...
-- count_rr_sessions_segment_daily
-- count_taxi_rr_sessions_segment_daily
with customer_segments AS (
    SELECT 
        segments.run_date as run_date,
        segments.taxi_lifetime_last_ride_city as taxi_lifetime_last_ride_city,
    ...
    select
        ...
        count(distinct segment_rr_merge.rr_unique_id) as count_taxi_rr_sessions_segment_daily
    from
...
-- count_taxi_rr_sessions_wo_parcel_segment_daily
with customer_segments AS (
    SELECT 
        segments.run_date as run_date,
        segments.taxi_lifetime_last_ride_city as taxi_lifetime_last_ride_city,
    ...
    from
        customer_segments as customer_segments
        left join rr_query as rr_query on customer_segments.customer_id = rr_query.user_id
        join service_level_mapping AS service_level_mapping ON service_level_mapping.service_detail_id = rr_query.service_details_id
    )
    select
        segment_rr_merge.taxi_usecase_segment,
        segment_rr_merge.predicted_age,
        ...
        segment_rr_merge.vehicle_ownership_signal,
        segment_rr_merge.new_repeat_signal,
        count(distinct segment_rr_merge.rr_unique_id) as count_taxi_rr_sessions_wo_parcel_segment_daily
    from
        segment_rr_merge as segment_rr_merge
    group by
        segment_rr_merge.taxi_usecase_segment,
...
-- count_gross_customer_segment_daily
-- count_gross_customer_segment_service_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        COUNT(DISTINCT segment_order_merge.customer_id) AS count_gross_customer_segment_service_daily
    FROM
...
-- count_gross_customer_wo_parcel_segment_daily



-- count_net_customer_segment_daily
-- count_net_customer_segment_service_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        COUNT(DISTINCT segment_order_merge.customer_id) AS count_net_customer_segment_service_daily
    FROM
        segment_order_merge AS segment_order_merge
    GROUP BY
        segment_order_merge.taxi_usecase_segment,
...
-- count_net_customer_wo_parcel_segment_daily


-- count_rr_orders_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        COUNT(DISTINCT segment_order_merge.order_id) AS count_rr_orders_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    GROUP BY
        segment_order_merge.taxi_usecase_segment,
...
-- count_net_orders_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        COUNT(DISTINCT segment_order_merge.order_id) AS count_net_orders_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    GROUP BY
        segment_order_merge.taxi_usecase_segment,
...
-- count_cobrm_orders_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        COUNT(DISTINCT segment_order_merge.order_id) AS count_cobrm_orders_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    GROUP BY
        segment_order_merge.taxi_usecase_segment,
...
-- count_cobra_order_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        COUNT(DISTINCT segment_order_merge.order_id) AS count_cobra_order_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    GROUP BY
        segment_order_merge.taxi_usecase_segment,
...
-- count_ocara_orders_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        COUNT(DISTINCT segment_order_merge.order_id) AS count_ocara_orders_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    GROUP BY
        segment_order_merge.taxi_usecase_segment,
...
-- count_expired_orders_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        COUNT(DISTINCT segment_order_merge.order_id) AS count_expired_orders_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    GROUP BY
        segment_order_merge.taxi_usecase_segment,
...
-- count_aborted_orders_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        COUNT(DISTINCT segment_order_merge.order_id) AS count_aborted_orders_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    GROUP BY
        segment_order_merge.taxi_usecase_segment,
...
-- sum_cobrm_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        SUM(segment_order_merge.cobrm_ttc_secs) AS sum_cobrm_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- perc_25_cobrm_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        PERCENTILE_APPROX(segment_order_merge.cobrm_ttc_secs , 0.25) AS perc_25_cobrm_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- perc_50_cobrm_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        PERCENTILE_APPROX(segment_order_merge.cobrm_ttc_secs , 0.50) AS perc_50_cobrm_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- perc_75_cobrm_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        PERCENTILE_APPROX(segment_order_merge.cobrm_ttc_secs , 0.75) AS perc_75_cobrm_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- perc_90_cobrm_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        PERCENTILE_APPROX(segment_order_merge.cobrm_ttc_secs , 0.90) AS perc_90_cobrm_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- perc_95_cobrm_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        PERCENTILE_APPROX(segment_order_merge.cobrm_ttc_secs , 0.95) AS perc_95_cobrm_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- sum_cobra_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        SUM(segment_order_merge.cobra_ttc_secs) AS sum_cobra_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- perc_25_cobra_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        PERCENTILE_APPROX(segment_order_merge.cobra_ttc_secs , 0.25) AS perc_25_cobra_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- perc_50_cobra_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        PERCENTILE_APPROX(segment_order_merge.cobra_ttc_secs , 0.50) AS perc_50_cobra_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- perc_75_cobra_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        PERCENTILE_APPROX(segment_order_merge.cobra_ttc_secs , 0.75) AS perc_75_cobra_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- perc_90_cobra_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        PERCENTILE_APPROX(segment_order_merge.cobra_ttc_secs , 0.90) AS perc_90_cobra_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- perc_95_cobra_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        PERCENTILE_APPROX(segment_order_merge.cobra_ttc_secs , 0.95) AS perc_95_cobra_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- sum_ocara_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        SUM(segment_order_merge.ocara_ttc_secs) AS sum_ocara_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- perc_25_ocara_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        PERCENTILE_APPROX(segment_order_merge.ocara_ttc_secs , 0.25) AS perc_25_ocara_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- perc_50_ocara_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        PERCENTILE_APPROX(segment_order_merge.ocara_ttc_secs , 0.50) AS perc_50_ocara_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- perc_75_ocara_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        PERCENTILE_APPROX(segment_order_merge.ocara_ttc_secs , 0.75) AS perc_75_ocara_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- perc_90_ocara_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        PERCENTILE_APPROX(segment_order_merge.ocara_ttc_secs , 0.90) AS perc_90_ocara_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- perc_95_ocara_ttc_secs_segment_daily
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.vehicle_ownership_signal,
        segment_order_merge.new_repeat_signal,
        PERCENTILE_APPROX(segment_order_merge.ocara_ttc_secs , 0.95) AS perc_95_ocara_ttc_secs_segment_daily
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
