-- count_gross_customer_segment_service_monthly
with customer_segments AS (
    ...
    SELECT
        ...
        COUNT(DISTINCT segment_order_merge.customer_id) AS count_gross_customer_segment_service_monthly
    FROM
...
-- perc_50_cobra_ttc_secs_segment_monthly
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.cross_sell_segment,
        segment_order_merge.geo_usecase_segment,
        PERCENTILE_APPROX(segment_order_merge.avg_cobrm_ttc_secs , 0.50) AS perc_50_cobra_ttc_secs_segment_monthly
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- sum_ocara_ttc_secs_segment_monthly
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.cross_sell_segment,
        segment_order_merge.geo_usecase_segment,
        SUM(segment_order_merge.ocara_ttc_secs) AS sum_ocara_ttc_secs_segment_monthly
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
...
-- perc_50_ao_to_fe_time_secs_segment_monthly
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        PERCENTILE_APPROX(final_data.ao2fe_time_sec , 0.50) AS perc_50_ao_to_fe_time_secs_segment_monthly
    FROM
...
-- M2
-- perc_25_ao_to_fe_time_secs_segment_monthly
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        final_data.cross_sell_segment,
        final_data.geo_usecase_segment,
        PERCENTILE_APPROX(final_data.ao2fe_time_sec , 0.25) AS perc_25_ao_to_fe_time_secs_segment_monthly
    FROM
        final_data AS final_data
    WHERE 
        final_data.ao2fe_time_sec > 0
...
-- perc_75_ao_to_fe_time_secs_segment_monthly
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        final_data.cross_sell_segment,
        final_data.geo_usecase_segment,
        PERCENTILE_APPROX(final_data.ao2fe_time_sec , 0.75) AS perc_75_ao_to_fe_time_secs_segment_monthly
    FROM
        final_data AS final_data
    WHERE 
        final_data.ao2fe_time_sec > 0
...
-- perc_90_ao_to_fe_time_secs_segment_monthly
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        final_data.cross_sell_segment,
        final_data.geo_usecase_segment,
        PERCENTILE_APPROX(final_data.ao2fe_time_sec , 0.90) AS perc_90_ao_to_fe_time_secs_segment_monthly
    FROM
        final_data AS final_data
    WHERE 
        final_data.ao2fe_time_sec > 0
...
-- perc_95_ao_to_fe_time_secs_segment_monthly
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        final_data.cross_sell_segment,
        final_data.geo_usecase_segment,
        PERCENTILE_APPROX(final_data.ao2fe_time_sec , 0.95) AS perc_95_ao_to_fe_time_secs_segment_monthly
    FROM
        final_data AS final_data
    WHERE 
        final_data.ao2fe_time_sec > 0
...
-- count_net_customer_segment_service_monthly
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.cross_sell_segment,
        segment_order_merge.geo_usecase_segment,
        COUNT(DISTINCT segment_order_merge.customer_id) AS count_net_customer_segment_service_monthly
    FROM
        segment_order_merge AS segment_order_merge
    GROUP BY
        segment_order_merge.taxi_usecase_segment,
...
-- count_cobrm_orders_segment_monthly
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.cross_sell_segment,
        segment_order_merge.geo_usecase_segment,
        COUNT(DISTINCT segment_order_merge.order_id) AS count_cobrm_orders_segment_monthly
    FROM
        segment_order_merge AS segment_order_merge
    GROUP BY
        segment_order_merge.taxi_usecase_segment,
...
-- count_rr_orders_segment_monthly
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.cross_sell_segment,
        segment_order_merge.geo_usecase_segment,
        COUNT(DISTINCT segment_order_merge.order_id) AS count_rr_orders_segment_monthly
    FROM
        segment_order_merge AS segment_order_merge
    GROUP BY
        segment_order_merge.taxi_usecase_segment,
...
-- perc_50_ocara_ttc_secs_segment_monthly
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        segment_order_merge.cross_sell_segment,
        segment_order_merge.geo_usecase_segment,
        PERCENTILE_APPROX(segment_order_merge.ocara_ttc_secs , 0.50) AS perc_50_ocara_ttc_secs_segment_monthly
    FROM
        segment_order_merge AS segment_order_merge
    group by
        segment_order_merge.taxi_usecase_segment,
