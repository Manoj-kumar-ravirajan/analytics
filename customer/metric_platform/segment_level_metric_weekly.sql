...
-- perc_25_ao_to_fe_time_secs_segment
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        final_data.cross_sell_segment,
        final_data.geo_usecase_segment,
        PERCENTILE_APPROX(final_data.ao2fe_time_sec , 0.25) AS perc_25_ao_to_fe_time_secs_segment
    FROM
        final_data AS final_data
    WHERE 
        final_data.ao2fe_time_sec > 0
...
-- perc_75_ao_to_fe_time_secs_segment
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        final_data.cross_sell_segment,
        final_data.geo_usecase_segment,
        PERCENTILE_APPROX(final_data.ao2fe_time_sec , 0.75) AS perc_75_ao_to_fe_time_secs_segment
    FROM
        final_data AS final_data
    WHERE 
        final_data.ao2fe_time_sec > 0
...
-- perc_90_ao_to_fe_time_secs_segment
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        final_data.cross_sell_segment,
        final_data.geo_usecase_segment,
        PERCENTILE_APPROX(final_data.ao2fe_time_sec , 0.90) AS perc_90_ao_to_fe_time_secs_segment
    FROM
        final_data AS final_data
    WHERE 
        final_data.ao2fe_time_sec > 0
...
-- perc_95_ao_to_fe_time_secs_segment
with customer_segments AS (
    SELECT 
        segments.customer_id AS customer_id, 
        segments.taxi_usecase_segment AS taxi_usecase_segment,
    ...
    SELECT
        ...
        final_data.cross_sell_segment,
        final_data.geo_usecase_segment,
        PERCENTILE_APPROX(final_data.ao2fe_time_sec , 0.95) AS perc_95_ao_to_fe_time_secs_segment
    FROM
        final_data AS final_data
    WHERE 
        final_data.ao2fe_time_sec > 0
